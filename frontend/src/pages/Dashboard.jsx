...
export default function Dashboard({setPage,setSelectedAnalysisId}){
 ...
 const unique=useMemo(()=>[...new Map(filteredItems.map(x=>[x.filename.toLowerCase(),x])).values()].sort((a,b)=>b.confidence-a.confidence),[filteredItems]);
 ...
 const lc=latest?.lightCurve||[],pc=latest?.phaseFoldedCurve||[],td=latest?.transits||[];
